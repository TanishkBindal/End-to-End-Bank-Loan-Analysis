...
- **Total Funded Amount: $435.8M** vs **Total Amount Received: $473.1M**, resulting in a positive net cash inflow of **$37.3M** — strong repayment health.
...
- **86.2%** of loans are **Good Loans** (33.2K applications) — strong underwriting performance.
- **Bad Loans** account for only **13.8%** (5.3K applications), keeping default exposure within manageable industry limits.
- **Good Loans funded: $370.2M** (≈85% of total exposure), showing capital concentration in low-risk borrowers.
- **Bad Loans funded: $65.5M**, yet only $37.3M recovered, highlighting default impact on recovery ratios.
- **Charged-off loans** (~5,333 accounts) align closely with the **13–14%** bad loan ratio, confirming portfolio consistency.
- **Monthly applications** increased from **2.3K (Jan) to 4.3K (Dec)** — nearly **87% growth** across the year.
...
- **Renters (18.4K applications)** slightly exceed **Mortgage holders (17.2K)** — renters may represent higher liquidity-driven borrowing.
...
- **Debt Consolidation dominates (18K applications)** — nearly half of the portfolio demand.
